<%-- 
    ...
    Created on : 7 dic 2025, 11:44:08 p. m.
    Author     : pablo
--%>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    ...
                                    <p>
                                        Usuario
                                        <small>${vendedor.nombreUsuario}</small>
                                    </p>
                                </li>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="#" onclick="cargarVista('vistas/resumen.jsp')"><i class="fa fa-link"></i> <span>Panel Usuario</span></a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Matriculas</a></li>
                            <li><a href="#"><i class="fa fa-tags"></i>Ventas</a></li>
                            <li><a href="#"><i class="fa fa-book"></i>Combinado</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Panel de Control <small>Usuario</small></h1>
                <ol class="breadcrumb">
    ...
    <!<!-- Codigo para cargar el contenido principal -->
    <script>
